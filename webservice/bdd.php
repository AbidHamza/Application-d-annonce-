...
// création une table pour contenir les utilisateurs
function creationTableUtilisateur() {
    $pdo = connexion();
    $requeteSQLCreation = 'CREATE TABLE "utilisateurs" (
...
function vidageTable() {
 ...
 function lecture(){
     $pdo =connexion();
     //$abc="SELECT * FROM annonces";
     $res= $pdo->query("SELECT * FROM annonces");
     $bcd = $res->fetchALL(PDO::FETCH_ASSOC);
     return $bcd;
